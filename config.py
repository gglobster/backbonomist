...
#             'offset': (16500,138000), 'ignore': (0, 0)}
...
references = [{'name': 'pXO1', 'file': 'pXO1.gbk', 'input': 'gbk',
               'refs': ({'coords': (1127,6561),'name': 'A', 'note': '3_10'},
                        {'coords': (8991,13756),'name': 'B', 'note': '12_17'},
                        {'coords': (19200,20894),'name': 'C',
                         'note': '20_20'},
                        {'coords': (21714,25117),'name': 'D',
                         'note': '23_25'},
                        {'coords': (28490,30979),'name': 'E',
                         'note': '30_34'},
                        {'coords': (38284,40203),'name': 'F',
                         'note': '45_46'},
                        {'coords': (52063,55796),'name': 'G',
                         'note': '64_65'},
                        {'coords': (55987,60586),'name': 'H',
                         'note': '66_69'},
                        {'coords': (61404,63518),'name': 'I',
                         'note': '71_74'},
                        {'coords': (64090,68866),'name': 'J',
                         'note': '75_79'},
                        {'coords': (69021,74102),'name': 'K',
                         'note': '80_84'},
                        {'coords': (74119,77871),'name': 'L',
                         'note': '85_90'},
                        {'coords': (79735,82867),'name': 'M',
                         'note': '93_97'},
                        {'coords': (83606,86696),'name': 'N',
                         'note': '98_101'},
                        {'coords': (87297,91464),'name': 'O',
                         'note': '103_107'},
                        {'coords': (91495,95163),'name': 'P',
                         'note': '108_108'},
                        {'coords': (95212,98847),'name': 'Q',
                         'note': '109_114'},
                        {'coords': (100828,102495),'name': 'R',
                         'note': '117_118'},
                        {'coords': (155257,157413),'name': 'S',
                         'note': '182_184'},
                        {'coords': (174223,176584),'name': 'T',
                         'note': '207_212'})}]
